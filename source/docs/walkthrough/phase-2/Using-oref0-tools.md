...
Code to make the `max_iob`file manually:
 ```
  $ nano max_iob.json
  ```

Note `max_iob` should be saved in the root of your openaps installation and not in the settings structure as you did in the previos steps.
